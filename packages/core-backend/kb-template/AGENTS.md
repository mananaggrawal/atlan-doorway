...
{{pluginsDir}}/<Plugin>/ai.atlan.doorway/tools/  `.tool` manuals
...
```json
{ "extensions": { "ai.atlan.doorway": { "skills": ["{{skillsDir}}/Engineering/deploy", "{{skillsDir}}/Sales"] } } }
```
...
## Tool Manuals (`{{pluginsDir}}/<Plugin>/ai.atlan.doorway/tools/*.tool`)
